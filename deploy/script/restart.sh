...
OUTSIDEBANK_ENV=environment nohup python -m outsidebank.push $target_push_port > ../logs/push.log 2>&1 &
OUTSIDEBANK_ENV=environment nohup python -m outsidebank.pull $target_pull_port > ../logs/pull.log 2>&1 &
OUTSIDEBANK_ENV=environment nohup python -m outsidebank.payment_monitor > ../logs/payment_monitor.log 2>&1 &
